...
Blockchain es una tecnología reciente la cual no se ha usado a gran escala, solo se ha visto implementada con exito en criptomonedas, pero esta tecnología fácilmente puede ser establecida como un protocolo para ser implementado en diferentes procesos sin importar si son financieros o inclusive sin procesos transaccionales.
\\
Blockchain se comporta como un libro de transacciones, distribuida y basado en {\LARGE encripción} lo cual garantiza la transparencia y seguridad en cada transacción, sin ahondar tecnicamente en su funcionamiento podemos indicar que \ldots
\\
mencionar los principios de blockchain 
\begin{itemize}
\item Base de datos distribuida
\item Transmisiones entre partes
\item Transparencia
\item Registros irreversibles
