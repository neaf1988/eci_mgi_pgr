...
\thesistitle{Blockchain aplicado en ambito no financiero} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
This work is deep research about how Blockchain should help and improve daily process, those process related to transactions would be taken with enhanced security, anonymity and decentralized \ldots
\end{abstract}
...
\\
Al {\supname} por la dedicación, paciencia y esfuerzo durante la consecución de este documento \ldots
